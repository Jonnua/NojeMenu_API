...
namespace NojeMenu_API.Controllers
{
    ...
    public class ShoppingCartController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse>> GetShopingCart(string userId)
        {
            try
            {
        ...
        public async Task<ActionResult<ApiResponse>> AddOrUpdateItemInCart(string userId, int menuItemId, int updateQuantityBy)
        {
            ...
            if (shoppingCart == null && updateQuantityBy > 0)
            {
                ...
                //CRATE A SHOPPING CART & ADD CART ITEM
            ...
            else
            {
                ...
                {
                    // item already exists in shopping cart and we have to update quantity
